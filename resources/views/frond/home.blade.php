<x-frond.layout.app title="SD Katolik Weetabula - Masa Depan Cerah Dimulai Di Sini"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                ...
                <div class="flex flex-col space-y-8 text-center lg:text-left">
                    ...
                    <p
                        ...
                        nilai-nilai Kristiani. Kami mendidik anak bangsa untuk unggul dalam prestasi, tangguh menghadapi
    ...
    <!-- Kepala Sekolah Section (Liquid Glass Design) -->
    <section class="relative py-20 lg:py-32 overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-700">

        <!-- Background Decor (Untuk efek biasan Liquid Glass) -->
        <div
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <!-- Left Content: Principal Image with Liquid Glass Effect -->
                ...
                <!-- Right Content: Typography & Quote -->
    ...
    <!-- Fasilitas Unggulan Section (Apple Bento Box & Pure Glassmorphism) -->
    <section
        class="relative py-24 lg:py-32 overflow-hidden bg-slate-100 dark:bg-slate-950 transition-colors duration-700">

        <!-- Abstract Vibrant Background Blobs (Sangat penting agar efek kaca terlihat) -->
        <div
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[280px]">
                ...
                <!-- Card 1: Ruang Kelas (Span 2 Columns, Span 2 Rows on large screens) -->
    ...
    <!-- Hero Section: Daftar Guru (Liquid Glass & Alpine.js Slider) -->
    <section
        class="relative py-24 lg:py-32 w-full min-h-screen flex items-center overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-700"
        x-data="{
            active: 0,
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="flex flex-col space-y-6 text-center lg:text-left">
                    ...
                    <p
                        class="text-base md:text-lg text-slate-600 dark:text-slate-300 leading-relaxed max-w-xl mx-auto lg:mx-0">
                        Kenali lebih dekat para pendidik inspiratif di SD Katolik Weetabula. Mereka bukan sekadar
                        mengajar, melainkan membimbing dengan hati untuk menggali potensi emas setiap siswa.
                    </p>

                    <!-- Navigation Dots (Manual Control) -->
                    <div class="flex items-center justify-center lg:justify-start space-x-3 pt-6">
                ...
                <!-- Right Column: The Pure Glass Slider -->
                <div class="relative w-full max-w-md mx-auto h-[550px] lg:h-[600px] flex justify-center"
                    ...
                    <template x-for="(slide, index) in slides" :key="index">
                        ...
                        <div x-show="active === index" x-transition:enter="transition ease-out duration-700 transform"
                            ...
                            class="absolute top-0 left-0 w-full h-full rounded-[2.5rem] overflow-hidden group">
    ...
    <!-- Testimoni Alumni Section dengan 10 Data Dinamis -->
    <section
        class="relative py-24 lg:py-32 overflow-hidden bg-slate-100 dark:bg-slate-900 transition-colors duration-700"
        x-data="{
            testimonis: [{
                    name: 'Gregorius Mahendra',
                    role: 'Alumni 2010 • Dokter Umum',
                    quote: 'Pendidikan karakter yang saya dapatkan di sini menjadi bekal yang paling berharga. Kedisiplinan dan nilai-nilai Katolik yang ditanamkan oleh para guru membantu saya beradaptasi dengan cepat saat melanjutkan pendidikan ke jenjang SMP, SMA, hingga akhirnya saya berhasil masuk ke fakultas kedokteran. Lingkungan yang suportif benar-benar membentuk mentalitas saya untuk tidak mudah menyerah saat menghadapi kesulitan.',
                    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1974&auto=format&fit=crop'
                },
                {
                    name: 'Maria Anastasia',
                    role: 'Alumni 2012 • Penulis',
                    quote: 'Saya sangat bersyukur pernah bersekolah di SD Katolik Weetabula. Guru-gurunya sangat sabar dan fasilitas perpustakaannya adalah tempat favorit saya menghabiskan waktu saat istirahat.',
                    image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=2070&auto=format&fit=crop'
                },
                {
                    name: 'Stefanus B.',
                    role: 'Alumni 2015 • Pengusaha',
                    quote: 'Ekstrakurikuler olahraga di sekolah ini sangat luar biasa! Mengajarkan saya arti kerja sama tim yang sebenarnya.',
                    image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=1974&auto=format&fit=crop'
                },
                {
                    name: 'Clara Monica',
                    role: 'Alumni 2018 • Mahasiswi',
                    quote: 'Lingkungan sekolah yang asri dan kawan-kawan yang ramah membuat masa SD saya penuh kenangan. Guru-guru tidak hanya fokus pada teori akademik, tapi juga cara kami bersosialisasi dan menghargai perbedaan orang lain.',
                    image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1964&auto=format&fit=crop'
                },
                {
                    name: 'Yohanes S.',
                    role: 'Alumni 2016 • Programmer',
                    quote: 'Pondasi logika dan matematika saya terbangun sangat kuat dari sekolah ini.',
                    image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=2070&auto=format&fit=crop'
                },
                {
                    name: 'Theresia Lende',
                    role: 'Alumni 2008 • Pengacara',
                    quote: 'Dulu saya anak yang sangat pemalu. Tapi berkat bimbingan para guru dan dorongan untuk sering tampil bernyanyi di paduan suara gereja bersama sekolah, saya menemukan rasa percaya diri saya. Keberanian untuk berbicara di depan umum yang saya miliki sekarang sebagai pengacara berawal dari panggung kecil di SD Katolik Weetabula. Terima kasih banyak!',
                    image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=1976&auto=format&fit=crop'
                },
                {
                    name: 'Antonius D.',
                    role: 'Alumni 2014 • Arsitek',
                    quote: 'Rutinitas doa pagi sebelum belajar adalah kebiasaan indah yang masih saya bawa sampai sekarang ke dunia kerja.',
                    image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=1974&auto=format&fit=crop'
                },
                {
                    name: 'Fransiska N.',
                    role: 'Alumni 2019 • Pelajar SMA',
                    quote: 'Fasilitas komputernya sangat membantu kami anak-anak daerah untuk tidak gagap teknologi sejak dini. Guru TIK-nya sangat asyik!',
                    image: 'https://images.unsplash.com/photo-1531123897727-8f129e1b4eca?q=80&w=1974&auto=format&fit=crop'
                },
                {
                    name: 'Markus B.',
                    role: 'Alumni 2011 • Pegawai Bank',
                    quote: 'Rasa kekeluargaan di SD Katolik Weetabula sangat erat. Tidak ada jarak antara guru dan murid. Kalau kita kesulitan belajar, guru dengan sukarela memberikan jam tambahan tanpa mengeluh.',
                    image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=1974&auto=format&fit=crop'
                },
                {
                    name: 'Agnes M.',
                    role: 'Alumni 2020 • Pelajar SMP',
                    quote: 'Bangga pernah menjadi bagian dari sekolah ini! Lulusan dari sini rata-rata mudah masuk ke SMP favorit.',
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
            ...
            <div class="text-center max-w-2xl mx-auto mb-16">
                ...
                <p class="text-lg text-slate-600 dark:text-slate-300">
                    Mendengar langsung dari mereka yang telah menjadikan SD Katolik Weetabula sebagai fondasi awal
                    meraih masa depan.
                </p>
            </div>
            ...
            <div class="columns-1 md:columns-2 lg:columns-3 gap-6 w-full">
                ...
                <template x-for="(item, index) in testimonis" :key="index">
                    ...
                    <!-- Card Container (break-inside-avoid sangat krusial disini) -->
                    <div
                        class="break-inside-avoid mb-6 relative group rounded-[2.5rem] overflow-hidden inline-block w-full">
