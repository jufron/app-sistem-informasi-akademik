    ...
    <section
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
                ...
                <!-- LEFT COLUMN: Portrait Image (Takes 5 columns) -->
                <div class="lg:col-span-5 relative w-full h-full">
                    ...
                    <div
                        ...
                        <div
                            class="absolute inset-0 bg-white/30 dark:bg-slate-800/40 backdrop-blur-3xl border border-white/50 dark:border-white/10 z-10 pointer-events-none">
                        </div>
                        <div
                            class="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/80 to-transparent z-30 pointer-events-none">
                        </div>
                ...
                <!-- RIGHT COLUMN: Detail Info & Typography (Takes 7 columns) -->
                <div class="lg:col-span-7 flex flex-col space-y-10 lg:py-6">
