<div class="form-button-action">
    <!-- Button Lihat -->
    <a href="{{ route('dashboard.mata-pelajaran.show', $row->id) }}" 
    ...
    <!-- Button Edit -->
    <a href="{{ route('dashboard.mata-pelajaran.edit', $row->id) }}" 
    ...
    <!-- Button Hapus -->
    <form action="{{ route('dashboard.mata-pelajaran.destroy', $row->id) }}" 
          method="POST" 
