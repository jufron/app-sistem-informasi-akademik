<div class="form-button-action">
    <!-- Button Lihat -->
    <a href="{{ route('dashboard.ruangan-kelas.show', $row->id) }}" 
    ...
    <!-- Button Edit -->
    <a href="{{ route('dashboard.ruangan-kelas.edit', $row->id) }}" 
    ...
    <!-- Button Hapus -->
    <form action="{{ route('dashboard.ruangan-kelas.destroy', $row->id) }}" 
          method="POST" 
