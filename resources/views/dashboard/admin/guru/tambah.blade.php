<x-dashboard.layoutDashboard.app title="Tambah Guru">
    <x-slot:myStyle>
        <style>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <x-dashboard.input
                            ...
                            name="password"
                            type="password"
                            placeholder="Masukkan Password Awal Akun"
                        />
                    </div>
                    <div class="col-md-4 mb-3">
                        <x-dashboard.input
                            ...
                            type="password"
                            placeholder="Konfirmasi Password Awal Akun"
                        />
                    </div>
                </div>
                    ...
                    <div class="col-md-3 mb-3 text-center border-end">
                        <div class="form-group p-0">
                            ...
                            <div class="preview-img-container">
                                <img id="img-preview" src="https://www.gravatar.com/avatar/default?d=mp&s=150" alt="Preview Foto" class="preview-img">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group @error('tipe') has-error @enderror">
                                    ...
                                    <select class="form-select @error('tipe') is-invalid @enderror" name="tipe">
                                        <option value="Bukan Wali Kelas" {{ old('tipe') == 'Bukan Wali Kelas' ? 'selected' : '' }}>Bukan Wali Kelas</option>
                                        <option value="Wali Kelas" {{ old('tipe') == 'Wali Kelas' ? 'selected' : '' }}>Wali Kelas</option>
                                        @if(!$hasKepalaSekolah)
                                            <option value="Kepala Sekolah" {{ old('tipe') == 'Kepala Sekolah' ? 'selected' : '' }}>Kepala Sekolah</option>
                                        @endif
                                    </select>
                                    @error('tipe')
                                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="subject-card d-flex align-items-center m-0 w-100">
                                <input type="checkbox" name="mata_pelajaran_ids[]" value="{{ $subject->id }}" class="form-check-input me-3"
                                    {{ is_array(old('mata_pelajaran_ids')) && in_array($subject->id, old('mata_pelajaran_ids')) ? 'checked' : '' }}>
                                <div>
